...
export class DashboardComponent implements OnInit {
  ...
  public lineChart1Colours: Array<any> = [
    {
      backgroundColor: this.getStyle('--primary'),
  ...
  public lineChart2Colours: Array<any> = [
    { // grey
      backgroundColor: this.getStyle('--info'),
      borderColor: 'rgba(255,255,255,.55)'
    }
  ];
  ...
  public mainChartColours: Array<any> = [
    { // brandInfo
      backgroundColor: this.hexToRgba(this.getStyle('--info'), 10),
      borderColor: this.getStyle('--info'),
      pointHoverBackgroundColor: '#fff'
    },
    { // brandSuccess
      backgroundColor: 'transparent',
      borderColor: this.getStyle('--success'),
      pointHoverBackgroundColor: '#fff'
    },
    { // brandDanger
      backgroundColor: 'transparent',
      borderColor: this.getStyle('--danger'),
      pointHoverBackgroundColor: '#fff',
      borderWidth: 1,
      borderDash: [8, 5]
    }
  ...
  public sparklineChartPrimary: Array<any> = [
    {
      backgroundColor: 'transparent',
      borderColor: this.getStyle('--primary'),
    }
  ];
  ...
  public sparklineChartWarning: Array<any> = [
    {
      backgroundColor: 'transparent',
      borderColor: this.getStyle('--warning'),
    }
  ];
